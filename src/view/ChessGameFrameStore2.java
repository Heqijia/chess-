...
public class ChessGameFrameStore2 extends JFrame {
    ...
    public ChessGameFrameStore2(int width, int height) {
...
//
//
        String fileName2 = "ChessData2.txt";
        ...
        button2.setLocation(HEIGTH, HEIGTH / 10 + 158);
    ...
    public static void main(String[] args){
        ChessGameFrameStore2 mainFrame = new ChessGameFrameStore2(800, 608);
