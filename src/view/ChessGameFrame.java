...
//        JLabel label=new JLabel(picture);        //add the picture to a label
    ...
    private void addChessboard() {//棋盘的初始化
        ...
        Load.setLocation(HEIGTH, HEIGTH / 10 + 152);
        Load.setSize(160, 48);
       ...
       Load.addActionListener(e -> {
        ...
        changeBackground.setLocation(HEIGTH, HEIGTH / 10 + 380);
        ...
        //JButton exit =new JButton("返回菜单");
        changeTheme.setLocation(HEIGTH, HEIGTH / 10 + 412);
